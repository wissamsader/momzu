...
A voice AI that lives on your Mac. Say its name hands-free. It talks back, browses your real Chrome, opens apps, reads your calendar, plays your music by name, runs routines, remembers you — and answers on your phone from across the house.
...
- **Hands-free** — turn on HANDS-FREE and just say *"Momzu, …"* from across the room. A soft chime confirms it heard you; say *"stop"* or *"wait"* to instantly abort anything, even mid-task.
- **Talks** — replies are spoken aloud with a natural local voice. Push-to-talk from anywhere with ⌥Space, hold the spacebar in the app, or just type.
...
3. **Talk** — hold space and speak, or switch on hands-free and just say **"Momzu"**.
